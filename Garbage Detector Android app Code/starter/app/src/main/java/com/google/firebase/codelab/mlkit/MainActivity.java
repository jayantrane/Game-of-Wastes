...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRunCustomModelButton.setVisibility(View.GONE);
        ...
        String[] items = new String[]{"Test Image 1 (Text)", "Test Image 2 (Text)", "Test Image 3" +
                " (Face)", "Test Image 4 (Object)", "Test Image 5 (Object)","Test Image 6","Test Image 7", "Test Image 8" };
                ...
                .addOnSuccessListener(new OnSuccessListener<List<FirebaseVisionImageLabel>>() {
                    ...
                    public void onSuccess(List<FirebaseVisionImageLabel> labels) {
                        ...
                        for (FirebaseVisionImageLabel label: labels) {
                           ...
                           if(text.toLowerCase()=="bottle"||text.toLowerCase()=="container"||text.toLowerCase()=="plastic"||text.toLowerCase()=="bins"||text.toLowerCase()=="box"||text.toLowerCase()=="electronics"||text.equals("Toy")||text.equals("Flowerpot")||text.equals("Bird"))
                            mTextView.setText("It is garbage with confidence "+confidence, TextView.BufferType.EDITABLE);
                           else
                               mTextView.setText("It is not " , TextView.BufferType.EDITABLE);
                      ...
                      //  mGraphicOverlay.clear();
                        //GraphicOverlay.Graphic labelGraphic = new LabelGraphic(mGraphicOverlay, labels );
                      //  mGraphicOverlay.add(labels);
                        // ...
                    }
                })
    ...
    public void onItemSelected(AdapterView<?> parent, View v, int position, long id) {
        ...
        switch (position) {
            ...
            case 5:
                // Whatever you want to happen when the thrid item gets selected
                mSelectedImage = getBitmapFromAsset(this, "image1.jpg");
                break;
            case 6:
                // Whatever you want to happen when the thrid item gets selected
                mSelectedImage = getBitmapFromAsset(this, "image2.jpg");
                break;
            case 7:
                // Whatever you want to happen when the thrid item gets selected
